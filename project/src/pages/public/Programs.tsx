    ...
    <>
      <section className="pt-32 pb-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Все направления</h1>
          <p className="text-lg text-gray-500 max-w-2xl">
            11 программ — от frontend до искусственного интеллекта. Выберите направление и начните обучение с нуля.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
            {programs.map((program) => {
              ...
              return (
                <div key={program.id} className="card p-6 group hover:-translate-y-1 transition-all duration-200">
