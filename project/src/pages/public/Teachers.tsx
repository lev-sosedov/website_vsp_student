      ...
      <section className="pt-32 pb-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-gray-500 max-w-2xl">
            Наши преподаватели — практикующие специалисты с опытом разработки, системного 
            администрирования, дизайна и цифровых технологий. Они помогают студентам получить 
            не только теоретические знания, но и практические навыки, необходимые для работы 
